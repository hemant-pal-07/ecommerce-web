...
<!-- Mirrored from spacingtech.com/html/erona/template/collection-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Oct 2025 07:45:00 GMT -->
...
<head>
    ...
    <body>
        ...
        <div class="breadcrumb-area ptb-30 bg-img text-center" data-bgimg="assets/image/other/breadcrumb-bgimg.jpg">
            <div class="container">
                <span class="d-block extra-color"><a href="index.html" class="extra-color">Home</a> / Collection category</span>
                <h2 class="extra-color font-24 font-xl-32 mst-5 mst-xl-9">Collection category</h2>
            </div>
        </div>
        <!-- breadcrumb-area end -->
        <!-- main start -->
                        ...
                        <div class="shop-cat-wrap">
                            <div class="shop-cat-slider swiper" id="shop-cat-slider">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="shop-cat-block banner-hover text-center">
                                            <a href="collection.html" class="d-block banner-img position-relative br-hidden">
                                                ...
                                                <span class="d-block primary-link position-absolute bottom-0 start-0 end-0 ptb-10 plr-15 body-bg meb-15 mlr-15 heading-weight text-truncate border-radius">Womens wear</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="shop-cat-block banner-hover text-center">
                                            <a href="collection.html" class="d-block banner-img position-relative br-hidden">
                                                ...
                                                <span class="d-block primary-link position-absolute bottom-0 start-0 end-0 ptb-10 plr-15 body-bg meb-15 mlr-15 heading-weight text-truncate border-radius">Mens wear</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="shop-cat-block banner-hover text-center">
                                            <a href="collection.html" class="d-block banner-img position-relative br-hidden">
                                                ...
                                                <span class="d-block primary-link position-absolute bottom-0 start-0 end-0 ptb-10 plr-15 body-bg meb-15 mlr-15 heading-weight text-truncate border-radius">Kids wear</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="shop-cat-block banner-hover text-center">
                                            <a href="collection.html" class="d-block banner-img position-relative br-hidden">
                                                ...
                                                <span class="d-block primary-link position-absolute bottom-0 start-0 end-0 ptb-10 plr-15 body-bg meb-15 mlr-15 heading-weight text-truncate border-radius">Tops and t-shirts</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="shop-cat-block banner-hover text-center">
                                            <a href="collection.html" class="d-block banner-img position-relative br-hidden">
                                                ...
                                                <span class="d-block primary-link position-absolute bottom-0 start-0 end-0 ptb-10 plr-15 body-bg meb-15 mlr-15 heading-weight text-truncate border-radius">Shirts</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="shop-cat-block banner-hover text-center">
                                            <a href="collection.html" class="d-block banner-img position-relative br-hidden">
                                                ...
                                                <span class="d-block primary-link position-absolute bottom-0 start-0 end-0 ptb-10 plr-15 body-bg meb-15 mlr-15 heading-weight text-truncate border-radius">Jumpsuits dresses</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="shop-cat-block banner-hover text-center">
                                            <a href="collection.html" class="d-block banner-img position-relative br-hidden">
                                                ...
                                                <span class="d-block primary-link position-absolute bottom-0 start-0 end-0 ptb-10 plr-15 body-bg meb-15 mlr-15 heading-weight text-truncate border-radius">Denim jeans</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="shop-cat-block banner-hover text-center">
                                            <a href="collection.html" class="d-block banner-img position-relative br-hidden">
                                                <img src="assets/image/collection/collection-8.jpg" class="w-100 img-fluid" alt="collection-8">
                                                <span class="d-block primary-link position-absolute bottom-0 start-0 end-0 ptb-10 plr-15 body-bg meb-15 mlr-15 heading-weight text-truncate border-radius">Outerwear collection</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="shop-cat-block banner-hover text-center">
                                            <a href="collection.html" class="d-block banner-img position-relative br-hidden">
                                                <img src="assets/image/collection/collection-9.jpg" class="w-100 img-fluid" alt="collection-9">
                                                <span class="d-block primary-link position-absolute bottom-0 start-0 end-0 ptb-10 plr-15 body-bg meb-15 mlr-15 heading-weight text-truncate border-radius">Shoes and footwear</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="shop-cat-block banner-hover text-center">
                                            <a href="collection.html" class="d-block banner-img position-relative br-hidden">
                                                <img src="assets/image/collection/collection-10.jpg" class="w-100 img-fluid" alt="collection-10">
                                                <span class="d-block primary-link position-absolute bottom-0 start-0 end-0 ptb-10 plr-15 body-bg meb-15 mlr-15 heading-weight text-truncate border-radius">Bags and accessories</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="shop-cat-block banner-hover text-center">
                                            <a href="collection.html" class="d-block banner-img position-relative br-hidden">
                                                <img src="assets/image/collection/collection-11.jpg" class="w-100 img-fluid" alt="collection-11">
                                                <span class="d-block primary-link position-absolute bottom-0 start-0 end-0 ptb-10 plr-15 body-bg meb-15 mlr-15 heading-weight text-truncate border-radius">Activewear styles</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="swiper-slide" data-animate="animate__fadeIn">
                                        <div class="shop-cat-block banner-hover text-center">
                                            <a href="collection.html" class="d-block banner-img position-relative br-hidden">
                                                <img src="assets/image/collection/collection-12.jpg" class="w-100 img-fluid" alt="collection-12">
                                                <span class="d-block primary-link position-absolute bottom-0 start-0 end-0 ptb-10 plr-15 body-bg meb-15 mlr-15 heading-weight text-truncate border-radius">Loungewear edit</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-buttons">
                                <div class="swiper-buttons-wrap">
                                    <button type="button" class="swiper-prev swiper-prev-shop-cat" aria-label="Arrow previous"><i class="ri-arrow-left-line d-block lh-1"></i></button>
                                    <button type="button" class="swiper-next swiper-next-shop-cat" aria-label="Arrow next"><i class="ri-arrow-right-line d-block lh-1"></i></button>
                                </div>
                            </div>
                                    ...
                                    <div class="shop-sidebar shop-categories">
                                        ...
                                        <div class="shop-cat-post mst-21">
                                            <div class="shop-cat ul-mtm-15">
                                                ...
                                                <a href="collection.html" class="body-primary-color d-flex align-items-center justify-content-between">
                                ...
                                <div class="col-12">
                                    <div class="row row-mtm15">
                                        ...
                                        <div class="collection-title">
                                            <h6 class="font-18">Collection category (12)</h6>
                                        </div>
...
<!-- Mirrored from spacingtech.com/html/erona/template/collection-category.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Oct 2025 07:45:01 GMT -->
</html>
