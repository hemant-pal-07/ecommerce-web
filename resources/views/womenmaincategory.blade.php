                                ...
                                <div class="swiper-wrapper">
                                   <div class="swiper-slide h-auto d-flex" data-animate="animate__fadeIn">
                                        <div class="cat-block banner-hover w-100 ptb-15 plr-15 body-bg border-radius">
                                            <a href="{{ route('womencollection1') }}" class="d-none d-xl-block position-relative banner-img br-hidden">
                                            ...
                                            <div class="cat-content pst-15">
                                                ...
                                                <div class="d-xl-none mst-7">
                                                    <a href="{{ route('collection') }}" class="link-btn">Shop now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide h-auto d-flex" data-animate="animate__fadeIn">
                                        <div class="cat-block banner-hover w-100 ptb-15 plr-15 body-bg border-radius">
                                            <a href="{{ route('womencollection2') }}" class="d-none d-xl-block position-relative banner-img br-hidden">
                                                <span class="btn-style tertiary-btn banner-btn position-absolute top-50 start-50 translate-middle z-1 text-nowrap">Shop now</span>
                                                  <img src="category_images/1764652565_topspinkimg.webp" class="w-100 img-fluid" alt="collection-5">
                                            </a>
                                            <a href="{{ route('collection2') }}" class="d-block d-xl-none banner-img br-hidden">
                                            ...
                                            <div class="cat-content pst-15">
                                                ...
                                                <div class="d-xl-none mst-7">
                                                    <a href="{{ route('collection2') }}" class="link-btn">Shop now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide h-auto d-flex" data-animate="animate__fadeIn">
                                        <div class="cat-block banner-hover w-100 ptb-15 plr-15 body-bg border-radius">
                                            <a href="{{ route('womencollection3') }}" class="d-none d-xl-block position-relative banner-img br-hidden">
                                                <span class="btn-style tertiary-btn banner-btn position-absolute top-50 start-50 translate-middle z-1 text-nowrap">Shop now</span>
                                                   <img src="category_images/1764653883_womenjeansimmg.jpg" class="w-100 img-fluid" alt="collection-5">
                                            </a>
                                            <a href="{{ route('collection3') }}" class="d-block d-xl-none banner-img br-hidden">
                                            ...
                                            <div class="cat-content pst-15">
                                                ...
                                                <div class="d-xl-none mst-7">
                                                    <a href="{{ route('collection3') }}" class="link-btn">Shop now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
