                                        ...
                                        <li class="menudrop-li bst">
                                            ...
                                            <div class="menusub-dropdown collapse" id="menu-account">
                                                <ul class="menusub-ul">
                                                    ...
                                                    <li class="menusub-li bst">
                                                        <span class="d-block ptb-10 psl-25 per-15"><a href="<?php echo e(route('signup')); ?>" class="d-inline-block body-color">Register</a></span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
...
<?php /**PATH C:\laravel_git\ecommerce-web\resources\views/login.blade.php ENDPATH**/ ?>