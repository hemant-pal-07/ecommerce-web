...
<!-- Mirrored from spacingtech.com/html/erona/template/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Oct 2025 07:45:45 GMT -->
    ...
    <body>
        ...
        <div class="breadcrumb-area ptb-30 bg-img text-center" data-bgimg="assets/image/other/breadcrumb-bgimg.jpg">
            <div class="container">
                ...
                <h2 class="extra-color font-24 font-xl-32 mst-5 mst-xl-9">About us</h2>
            </div>
        </div>
        <!-- breadcrumb-area end -->
        <!-- main start -->
        <main id="main">
                ...
                <div class="container">
                    <div class="section-capture text-center">
                        <div class="section-title" data-animate="animate__fadeIn">
                            <h2 class="section-heading">About story</h2>
                        </div>
                    </div>
                    <div class="about-banner" data-animate="animate__fadeIn">
                        <div class="banner-hover">
                            <span class="d-block banner-img br-hidden">
                                <img src="assets/image/other/about-banner1.jpg" class="w-100 img-fluid" alt="about-banner1">
                            </span>
                        </div>
                    </div>
                    <div class="about-service section-pt text-center">
                        <div class="row row-mtm justify-content-md-center">
                            <div class="col-12 col-lg-4" data-animate="animate__fadeIn">
                                <div class="col-xxl-10 mx-xxl-auto">
                                    <h6 class="font-18">5000+ Happy customer</h6>
                                    <p class="mst-18">Absolutely delighted with the service! The team was professional and delivered beyond my expectations. Highly recommend!</p>
                                </div>
                            </div>
                            <div class="col-12 col-lg-4" data-animate="animate__fadeIn">
                                <div class="col-xxl-10 mx-xxl-auto">
                                    <h6 class="font-18">29+ Awards won</h6>
                                    <p class="mst-18">Our company has been honored with the Outstanding Achievement Award and Best Industry Leader accolades in recent years.</p>
                                </div>
                            </div>
                            <div class="col-12 col-lg-4" data-animate="animate__fadeIn">
                                <div class="col-xxl-10 mx-xxl-auto">
                                    <h6 class="font-18">40+ years of experiences</h6>
                                    <p class="mst-18">With over all years of combined experience in the industry, our team excels in delivering top-notch solutions and services.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="about-testimonial section-ptb">
                <div class="container">
                    <div class="other-swiper-wrap">
                        <div class="row">
                            <div class="col-12 col-md-9 col-lg-8 col-xl-6 col-xxl-5 mx-md-auto text-center">
                                <div class="about-testislider swiper" id="about-testislider">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide" data-animate="animate__fadeIn">
                                            <div class="about-testi-content">
                                                <span class="d-inline-block about-testi-img ptb-8 plr-8 body-bg rounded-circle"><img src="assets/image/other/about-testi1.jpg" class="width-80 img-fluid rounded-circle" alt="about-testi1"></span>
                                                <div class="heading-color mst-26 text-uppercase">We love our clients</div>
                                                <p class="font-18 font-xl-20 mst-8 mst-xl-15">There are many variations of passages of available, but the majority have suffered alteration in some is by injected humour</p>
                                                <div class="primary-color mst-8 mst-xl-15 text-uppercase heading-weight">Wesley bates</div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide" data-animate="animate__fadeIn">
                                            <div class="about-testi-content">
                                                <span class="d-inline-block about-testi-img ptb-8 plr-8 body-bg rounded-circle"><img src="assets/image/other/about-testi2.jpg" class="width-80 img-fluid rounded-circle" alt="about-testi2"></span>
                                                <div class="heading-color mst-26 text-uppercase">We love our clients</div>
                                                <p class="font-18 font-xl-20 mst-8 mst-xl-15">There are many variations of passages of available, but the majority have suffered alteration in some is by injected humour</p>
                                                <div class="primary-color mst-8 mst-xl-15 text-uppercase heading-weight">Paul smith</div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide" data-animate="animate__fadeIn">
                                            <div class="about-testi-content">
                                                <span class="d-inline-block about-testi-img ptb-8 plr-8 body-bg rounded-circle"><img src="assets/image/other/about-testi3.jpg" class="width-80 img-fluid rounded-circle" alt="about-testi3"></span>
                                                <div class="heading-color mst-26 text-uppercase">We love our clients</div>
                                                <p class="font-18 font-xl-20 mst-8 mst-xl-15">There are many variations of passages of available, but the majority have suffered alteration in some is by injected humour</p>
                                                <div class="primary-color mst-8 mst-xl-15 text-uppercase heading-weight">Ashley rosa</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-buttons">
                                    <div class="swiper-buttons-wrap">
                                        <button type="button" class="swiper-prev swiper-prev-about-testi" aria-label="Arrow previous"><i class="ri-arrow-left-line d-block lh-1"></i></button>
                                        <button type="button" class="swiper-next swiper-next-about-testi" aria-label="Arrow next"><i class="ri-arrow-right-line d-block lh-1"></i></button>
                                    </div>
                                </div>
                                <div class="swiper-dots d-none" data-animate="animate__fadeIn">
                                    <div class="swiper-pagination swiper-pagination-about-testi"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="about-us-banner">
                <div class="container">
                    <div class="about-banner" data-animate="animate__fadeIn">
                        <div class="banner-hover">
                            <span class="d-block banner-img br-hidden">
                                <img src="assets/image/other/about-banner2.jpg" class="w-100 img-fluid" alt="about-banner2">
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row row-mtm justify-content-md-center">
                        <div class="col-12 col-lg-6" data-animate="animate__fadeIn">
                            <div class="col-lg-10 col-xl-9 col-xxl-7 mx-lg-auto">
                                <h6 class="font-18">Leading with innovation since 1982, Committed to excellence</h6>
                                <p class="mst-18">Founded in 1982, our company has thrived by blending experience with cutting-edge solutions, ensuring exceptional results.</p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6" data-animate="animate__fadeIn">
                            <div class="col-lg-10 col-xl-9 col-xxl-7 mx-lg-auto">
                                <h6 class="font-18">Transforming ideas into success with integrity and vision</h6>
                                <p class="mst-18">Since our inception, we’ve turned visionary ideas into successful outcomes, driven by integrity and a clear vision for the future.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="about-team section-ptb">
                <div class="container">
                    ...
                    <div class="row row-mtm text-center">
                        <div class="col-6 col-lg-3" data-animate="animate__fadeIn">
                            <div class="about-team-content banner-hover">
                                <div class="about-team-img">
                                    <span class="d-block banner-img br-hidden">
                                        <img src="assets/image/other/about-team1.jpg" class="w-100 img-fluid" alt="about-team1">
                                    </span>
                                </div>
                                <div class="about-team-info pst-25">
                                    <h6 class="font-18">Johnny walker</h6>
                                    <span class="d-block mst-6">Web designer</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-lg-3" data-animate="animate__fadeIn">
                            <div class="about-team-content banner-hover">
                                ...
                                <div class="about-team-info pst-25">
                                    ...
                                    <span class="d-block mst-6">Support staff</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-lg-3" data-animate="animate__fadeIn">
                            <div class="about-team-content banner-hover">
                                ...
                                <div class="about-team-info pst-25">
                                    ...
                                    <span class="d-block mst-6">Deputy sale</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-6 col-lg-3" data-animate="animate__fadeIn">
                            <div class="about-team-content banner-hover">
                                ...
                                <div class="about-team-info pst-25">
                                    ...
                                    <span class="d-block mst-6">Policy member</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from spacingtech.com/html/erona/template/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Oct 2025 07:45:47 GMT -->
</html>
<?php /**PATH C:\laravel_git\ecommerce-web\resources\views/about.blade.php ENDPATH**/ ?>