...
.icon-btn:hover{
 ...
 <div id="sidebar1" class="sidebar1 p-5 bg-primary text-white d-lg-none ">
   ...
   <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" href="<?php echo e(route('addproduct')); ?>"><i class="bi bi-backpack4 me-2"></i>Add category</a>
    </li>
     <li class="nav-item">
    ...
    <div class="col-md-6 d-flex flex-column flex-md-row gap-2 mt-2 text-center justify-content-center">
       <a href="<?php echo e(route('addproduct')); ?>"class="btn btn-primary ms-auto  align-items-center justify-content-center">
...
<?php /**PATH C:\laravel_git\ecommerce-web\resources\views/dashboard.blade.php ENDPATH**/ ?>